package org.sndo.data.sdk.java;

import org.sndo.data.sdk.java.consumer.Consumer;
import org.sndo.data.sdk.java.exceptions.InvalidArgumentException;
...
public class SndoDataAnalytics {
    ...
    /**
     * 停止SndoDataAPI所有线程，API停止前会清空所有本地数据
     */
